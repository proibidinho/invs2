...
O projeto utiliza o inventário AWS sincronizado no **Ansible Automation Platform (AAP)** como fonte oficial de dados para cadastro de servidores no CMDB.

Seguindo o mesmo padrão adotado para Azure e GCP, todas as informações consumidas pelo processo são obtidas diretamente do inventário do AAP, evitando consultas adicionais à AWS durante o sync.
...
Dessa forma não é necessário executar consultas adicionais na AWS durante o sync.
